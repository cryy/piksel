...
var SvgIcon = _interopDefault(require('@mui/material/SvgIcon'));
...
var StyledSnackbar = /*#__PURE__*/styles.styled(Snackbar)(function (_ref) {
  ...
  var themeBackgroundColor = theme.palette.background["default"];

  if (themeBackgroundColor.startsWith("linear-gradient")) {
    var splitArray = themeBackgroundColor.split(", ");
    themeBackgroundColor = splitArray[splitArray.length - 1].split(" ")[0];
  }

  var backgroundColor = styles.emphasize(themeBackgroundColor, mode === 'light' ? 0.8 : 0.98);
